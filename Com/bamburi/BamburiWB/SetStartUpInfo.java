...
{	
	public VtiUserExitResult execute() throws VtiExitException
	{
		...
		VtiUserExitScreenField supportField = getScreenField("SUPPORT");
		...
		{
			if(!authLevelField.getFieldValue().equalsIgnoreCase("ADMIN") && supportField == null)
			{
			...
			else if(!authLevelField.getFieldValue().equalsIgnoreCase("SUPPORT") && supportField != null)
			{
				Log.warn("Wrongfull access attempted by " + sessionHeader.getUserId());
				return new VtiUserExitResult(999, sessionHeader.getUserId() + " have no Support rights.");
			}
		}
